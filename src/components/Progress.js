            ...
            <div className="cont">
                ...
                <div className="progress-circle">
                    <svg width={size} height={size} className='circular'>
                        ...
                        <circle className='circle' stroke={circleTwoStroke} cx={center} cy={center} r={radius} strokeWidth={strokeWidth} strokeDasharray={circumfence} strokeDashoffset={offset} ref={circleRef}/>
