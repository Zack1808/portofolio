    ...
    return (
        <div className='about-me-container' ref={top}>
            ...
            <div className="segment-list-container" ref={segmentRef}>
                ...
                <h1 className={`edu ${inView && "visible"}`} ref={ref}>Education</h1>
